...
__repo__ = "https://github.com/bjones14/micropython_AS7341.git"
 ...
 * @return true: success false: failure
    ...
    def __init__(self, i2c, address=_AS7341_I2CADDR_DEFAULT):
    ...
    def _wait_for_data(self, timeout_ms=1000):
        ...
        while not self._data_ready_bit:
            if time.ticks_diff(start, time.ticks_ms()) > timeout_ms:
    ...
    @led_current.setter
    @_low_bank
    def led_current(self, led_current):
